...
### ইন্সটলের সময় `Could not find a version of package botblemedia/media-manager` ত্রুটি দেখায়

এখনো স্থিতিশীল কোনো রিলিজ ট্যাগ না থাকায় Composer কেবল নিচের যেকোনো একটি পদ্ধতিতে প্যাকেজটি ইন্সটল করতে দেবে:

- ডেভেলপমেন্ট ব্রাঞ্চ কন্সট্রেইন্ট ব্যবহার করুন: `composer require botblemedia/media-manager:dev-main`
- আপনার প্রজেক্টের `composer.json` ফাইলে নিচের অংশ যোগ করে `minimum-stability` কমিয়ে দিন (অন্য ডিপেনডেন্সিগুলো যেন স্থিতিশীল থাকে সেজন্য `prefer-stable` অপরিবর্তিত রাখুন):
...
`composer.json` আপডেটের পর `composer update botblemedia/media-manager` চালিয়ে পুনরায় চেষ্টা করুন।
